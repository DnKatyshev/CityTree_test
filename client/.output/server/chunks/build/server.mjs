import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, createVNode, Transition, mergeProps, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, normalizeStyle, normalizeClass, createElementVNode, useId, provide, onScopeDispose, withDirectives, vShow, Fragment, toDisplayString, reactive, inject as inject$1, toRaw, createTextVNode, capitalize, h, readonly, defineComponent as defineComponent$1, createElementBlock, cloneVNode, useSSRContext, createApp, TransitionGroup, camelize, unref, isRef, toValue, resolveDynamicComponent, Text, markRaw, resolveComponent, render, mergeModels, useModel, withCtx, createBlock, openBlock, renderList, onErrorCaptured, onServerPrefetch, shallowReactive, effectScope, isReadonly, isShallow, isReactive, warn, defineAsyncComponent, getCurrentScope, vModelText, Teleport, withModifiers, isVNode, Comment, normalizeProps, guardReactiveProps } from 'vue';
import { k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, n as sanitizeStatusCode, o as getContext, $ as $fetch$1, p as createHooks, h as createError$1, q as isEqual$1, r as stringifyParsedURL, v as stringifyQuery, x as parseQuery, y as toRouteMatcher, z as createRouter, A as defu, B as hash } from '../_/nitro.mjs';
...
function transformItems$3(props, items) {
  const _props = pick$1(props, ["itemTitle", "itemValue", "itemChildren", "itemProps", "itemType", "returnObject", "valueComparator"]);
  const array = [];
...
const makeVStepperProps = propsFactory({
  ...
  ...makeVSheetProps(),
  ...pick$1(makeVStepperActionsProps(), ["prevText", "nextText"])
}, "VStepper");
...
const makeVTreeviewChildrenProps = propsFactory({
  ...
  ...pick$1(makeVTreeviewItemProps(), ["hideActions"]),
  ...makeDensityProps()
}, "VTreeviewChildren");
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent$1({
  ...
  emits: /* @__PURE__ */ mergeModels(["open-add-dialog"], ["update:modelValue"]),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                  ...
                  ssrRenderList(_ctx.tabs, (tab, index) => {
                    _push3(ssrRenderComponent(_component_v_tab, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate(tab.join(" → "))}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(tab.join(" → ")), 1)
                          ];
                        }
                      }),
                      _: 2
            ...
            _push2(ssrRenderComponent(_component_v_btn, {
              color: "primary",
              onClick: ($event) => emit("open-add-dialog")
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Добавить`);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    const tree = computed(() => {
      ...
      const result = {};
      for (const person of props.citizens) {
        let current = result;
        for (const level of props.hierarchy) {
          let key = level === "country" ? defaultCountry : ((_a2 = person.groups.find((g) => g.type === level)) == null ? void 0 : _a2.name) || "—";
          if (!current[key]) current[key] = {};
          current = current[key];
        }
        if (!current.residents) current.residents = [];
        current.residents.push({
          name: person.name,
          tooltip: person.cityInfo ? `${person.cityInfo.name}, население: ${person.cityInfo.data}` : null
        });
      }
      const toArray = (obj) => Object.entries(obj).map(([name, value]) => ({
        name,
        children: value.residents ? value.residents.map((r) => ({ name: r.name, tooltip: r.tooltip })) : toArray(value)
      }));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_treeview, mergeProps({
        ...
        label: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (item.tooltip) {
              _push2(ssrRenderComponent(_component_v_tooltip, { location: "top" }, {
                activator: withCtx(({ props: props2 }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span${ssrRenderAttrs(props2)}${_scopeId2}>${ssrInterpolate(item.name)}</span>`);
                  } else {
                    return [
                      createVNode("span", props2, toDisplayString(item.name), 17)
                    ];
                  }
                }),
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span${_scopeId2}>${ssrInterpolate(item.tooltip)}</span>`);
                  } else {
                    return [
                      createVNode("span", null, toDisplayString(item.tooltip), 1)
                    ];
                  }
                }),
                _: 2
            ...
            return [
              item.tooltip ? (openBlock(), createBlock(_component_v_tooltip, {
                key: 0,
                location: "top"
              }, {
                ...
                _: 2
              }, 1024)) : (openBlock(), createBlock(Fragment, { key: 1 }, [
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent$1({
  __name: "AddCitizenDialog",
  __ssrInlineRender: true,
  props: {
    "modelValue": { type: Boolean },
    "modelModifiers": {}
  },
  emits: /* @__PURE__ */ mergeModels(["submitted"], ["update:modelValue"]),
  setup(__props, { emit: __emit }) {
    const model = useModel(__props, "modelValue");
    const emit = __emit;
    const form = ref({
    ...
    const submit = async () => {
      const body = {
        ...
        groups: form.value.groups.map((str) => {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_card_title, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Добавить жителя`);
                      } else {
                        return [
                          createTextVNode("Добавить жителя")
                        ];
                      }
                    }),
                    _: 1
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_v_select, {
                          label: "Группы (city, district, street)",
                          modelValue: form.value.groups,
                          "onUpdate:modelValue": ($event) => form.value.groups = $event,
                          multiple: "",
                          chips: "",
                          hint: "Формат: type:name, например: city:Москва г."
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AddCitizenDialog.vue");
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$5, {
                    tabs: hierarchyOptions,
                    modelValue: selectedHierarchy.value,
                    "onUpdate:modelValue": ($event) => selectedHierarchy.value = $event,
                    onOpenAddDialog: ($event) => dialog.value = true
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    citizens: citizens.value,
                    hierarchy: selectedHierarchy.value
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    modelValue: dialog.value,
                    "onUpdate:modelValue": ($event) => dialog.value = $event,
                    onSubmitted: fetchCitizens
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_sfc_main$5, {
                      ...
                      "onUpdate:modelValue": ($event) => selectedHierarchy.value = $event,
                      onOpenAddDialog: ($event) => dialog.value = true
                    }, null, 8, ["modelValue", "onUpdate:modelValue", "onOpenAddDialog"]),
                    createVNode(_sfc_main$4, {
                      citizens: citizens.value,
                      hierarchy: selectedHierarchy.value
                    }, null, 8, ["citizens", "hierarchy"]),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-rWt1QwbE.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DgiOY_Vl.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter$1 as u };
